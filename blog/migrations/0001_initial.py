...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_post', (
            ...
            ('short_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            (u'_annotation_rendered', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('annotation', self.gf('precise_bbcode.fields.BBCodeTextField')(no_rendered_field=True)),
            (u'_full_text_rendered', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('full_text', self.gf('precise_bbcode.fields.BBCodeTextField')(no_rendered_field=True)),
        ))
        ...
        db.create_table(u'blog_comment', (
            ...
            ('author_name', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
