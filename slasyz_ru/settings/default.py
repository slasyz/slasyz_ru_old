...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'slasyz.ru']

SITE_ID = 1

EMAIL_USE_TLS = True
EMAIL_HOST = 'smtp.yandex.ru'
EMAIL_HOST_USER = 'no-reply@slasyz.ru'
EMAIL_HOST_PASSWORD = ''

EMAIL_SUBJECT_PREFIX = '[slasyz.ru] '
DEFAULT_FROM_EMAIL = 'Slasyz.ru Admin <no-reply@slasyz.ru>'
...
STATIC_ROOT = '/home/sl/www/slasyz.ru/static'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'slasyz_ru.context_processors.default',
)
...
ROOT_URLCONF = 'slasyz_ru.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'slasyz_ru.wsgi.application'
